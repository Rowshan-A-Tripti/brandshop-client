...
const Tesla = () => {
    ...
    useEffect(() => {
        ...
        const cycleCar = cycleData.filter(cycle => cycle.brandName == 'Tesla')
        setCycles(cycleCar);
    }, [cycleData])
        ...
        <div>
            ...
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/kQ3xrSy/tesla1.jpg" className="w-full" />
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/Sr6SSJ5/tesla2.jpg" className="w-full" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/tX9nknt/tesla3.jpg" className="w-full" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide3" className="btn btn-circle">❮</a>
                        <div className="grid justify-start">
                            <h1 className="text-white  font-bold text-2xl lg:text-5xl"> We are offering best<br /> <span className="text-3xl lg:text-7xl text-orange-400 italic">services.</span></h1>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
                {
                    cycles.map(car => <div className="grid rounded-xl bg-gradient-to-r from-white via-orange-200 to-sky-600 md:grid-cols-2 " key={car._id}>
