...
const Toyota = () => {
    ...
    useEffect(() => {
        ...
        const toyotaCar = toyotaData.filter(toyota => toyota.brandName == 'Toyota')
        setToyotas(toyotaCar);
    }, [toyotaData])
    return (
        <div className="max-w-screen-xl mx-auto">
            ...
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/9tswqX0/toyota1.jpg" className="w-full" />
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/mzN8Jv1/toyota2.jpg" className="w-full" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/QFFJ5X2/toyota3.jpg" className="w-full" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide3" className="btn btn-circle">❮</a>
                        <div className="grid justify-start">
                            <h1 className="text-white  font-bold text-2xl lg:text-5xl"> We are offering best<br /> <span className="text-3xl lg:text-7xl text-orange-400 italic">services.</span></h1>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
                {
                    toyotas.map(car => <div className="grid rounded-xl bg-gradient-to-r from-white via-orange-200 to-sky-600 md:grid-cols-2 " key={car._id}>
                        ...
                        <div className="pl-6">
                            ...
                            <p className="text-lg font-semibold text-red-800"><Rating
                                                emptySymbol={<svg
