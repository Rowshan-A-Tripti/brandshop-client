...
const Ford = () => {
    const [fords, setFords] = useState([]);
    const fordData = useLoaderData();
    useEffect(() => {

        const fordCar = fordData.filter(ford => ford.brandName == 'Ford')
        setFords(fordCar);
    }, [fordData])
        ...
        <div className="max-w-screen-xl mx-auto">
            ...
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/N3mxW8J/ford1.jpg" className="w-full" />
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/6Nknd86/ford2.jpg" className="w-full" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="https://i.ibb.co/L66DdZH/ford3.jpg" className="w-full" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide2" className="btn btn-circle">❮</a>
                        <div className="grid justify-start">
                            <h1 className="text-white  font-bold text-2xl lg:text-5xl"> We are offering best<br /> <span className="text-3xl lg:text-7xl text-orange-400 italic">services.</span></h1>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
                {
                    fords.map(car => <div className="grid rounded-xl bg-gradient-to-r from-white via-orange-200 to-sky-600 md:grid-cols-2 " key={car._id}>
